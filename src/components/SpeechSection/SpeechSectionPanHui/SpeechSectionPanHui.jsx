...
const speechTextPanHui = {
    ...
    'zh-Hans': [
        ...
        `特别致敬我的策展团队：你们以开拓者的勇气，将“不可能”化为可能。媒体曾问：“大空间扩展现实技术风险极高，为什么你们敢为人先？”我的回答始终如一：既然投入相同时间，何不创造独一无二的价值？这份底气，源自我们敢想敢做的团队基因，也源自每位艺术家的非凡创造力。`,
        `尤其感动于国际参展艺术家的执着：有人从南美辗转抵达多哈，却因军事冲突在沙特紧急迫降；有人因列车延误错过航班，最终在旧金山紧急备降……这些跌宕起伏的旅程，正如我们突破技术边界的写照。`,
        `衷心感谢港科大（广州）及法国领事馆的鼎力支持。此刻的启幕仅是开始——我们已收到国际巡展邀约。然而，再多文字描述也不及亲临现场的震撼：当虚拟与现实在 3000㎡ 空间交织，您将见证艺术科技的无限可能。`,
    ],
};

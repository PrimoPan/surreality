// src/pages/PanHui/PanHui.jsx
import React from 'react';
import './PanHui.css';
import { t as _t } from '../../components/i18n'; // your helper

export default function PanHui({ lang = 'en' }) {
    // 1️⃣ all of our base fields, with _en and _cn suffixes
    const texts = {
        name_en: 'Professor Pan Hui',
        name_cn: '许彬 教授',

        pos_en: 'Director, MC2 – HKUST(GZ)',
        pos_cn: '香港科技大学（广州）MC2 中心主任',
...
许教授发表学术论文 500 余篇、引用逾 35 000 次，拥有 30 项欧美专利（AR、移动计算、数据科学）。他是英国皇家工程院国际院士、欧洲科学院院士、IEEE 会士及 ACM 杰出科学家，并任国际刑警组织元宇宙专家组及世界经济论坛元宇宙未来全球委员会成员。
    ...
    // 2️⃣ pull the proper localized text (en / 简 / 繁)
